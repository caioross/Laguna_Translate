...
window.LAGUNA_I18N = {
  pt: {
    ...
    "status.capture_retry": "Reconectando captura [{device}]… tentativa {attempt}/{max} ({detail})",
    ...
    "error.capture_lost": "Captura perdida [{device}] — verifique o dispositivo e reinicie. ({detail})",
    ...
    "mt.hallucination": "(ruído descartado — sem tradução)",
  ...
  en: {
    ...
    "status.capture_retry": "Reconnecting capture [{device}]… attempt {attempt}/{max} ({detail})",
    ...
    "error.input_stream": "InputStream: {detail}",
    "error.capture_lost": "Capture lost [{device}] — check the device and restart. ({detail})",
    ...
    "mt.hallucination": "(noise discarded — no translation)",
